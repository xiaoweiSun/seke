...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">	
    ...
    <head>
        ...
        <style type="text/css" media="screen"> 
			...
			body { margin:0 auto; padding:0; overflow:auto; text-align:center; 
...
<!--				alert("clickhandler!");-->
			...
			function MouseEventHandler()
			{
				...
				if (userdata["mouseEventType"] == "doubleClick")
				{
					...
					for(var j=0;j<edgn;j++)
					{
						...
						if( t[1] == focus )
						{
							GraphShow.setUserData("name",t[2]);
							GraphShow.AddElement();
						...
						if(t[2] == focus)
						{
							GraphShow.setUserData("name",t[1]);
							GraphShow.AddElement();
			...
			function mainFrameReview(focus)//执行中心点显示
			{
